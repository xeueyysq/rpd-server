...
function generatePDF() {
  return new Promise(async (resolve, reject) => {
    ...
    const TimesNewRomanBoldItalic =
      "app/fonts/times-new-roman-cyr-bolditalic.ttf";
    ...
    try {
      uniName = await new RpdChangeableValues(pool).getChangeableValue(
        "uniName"
      );
      approvalField = await new RpdChangeableValues(pool).getChangeableValue(
        "ApprovalField"
      );
      jsonData = await new RpdProfileTemplates(pool).getJsonProfile(
        "ivt_bakalavr"
      );
    } catch (error) {
      reject(error);
    ...
    doc
      .text("Факультет системного анализа и управления", { align: "center" })
      .moveDown(0.5);
    doc
      .text("Кафедра системного анализа и управления", { align: "center" })
      .moveDown(5.5);
    ...
    doc
      .fontSize(12)
      .text("Направление подготовки", { align: "center" })
      .moveDown(0.5);
    doc
      .fontSize(14)
      .text(jsonData.direction_of_study, {
        align: "center",
        underline: "black",
      })
      .moveDown(1.5);
    ...
    doc
      .fontSize(12)
      .text("Уровень высшего образования", { align: "center" })
      .moveDown(0.5);
    doc
      .fontSize(14)
      .text(jsonData.level_education, { align: "center", underline: "black" })
      .moveDown(1.5);

    doc
      .fontSize(12)
      .text("Направленность (профиль) программы", { align: "center" })
      .moveDown(0.5);
    doc
      .fontSize(14)
      .text(jsonData.profile, { align: "center", underline: "black" })
      .moveDown(1.5);

    doc
      .fontSize(12)
      .text("Форма(ы) обучения", { align: "center" })
      .moveDown(0.5);
    doc
      .fontSize(14)
      .text(jsonData.form_education, { align: "center", underline: "black" })
      .moveDown(3.5);
    ...
    doc
      .font(TimesNewRomanItalic)
      .fontSize(10)
      .text(
        "Фамилия И.О., должность, ученая степень (при наличии),                                      подпись",
        { align: "center" }
      )
      .moveDown(0.1);
    doc
      .text("ученое звание (при наличии), кафедра", {
        align: "center",
        width: "320",
      })
      .moveDown(2.5);
    ...
    doc
      .font(TimesNewRomanItalic)
      .fontSize(10)
      .text("(код и наименование направления подготовки (специальности))", {
        align: "center",
      })
      .moveDown(1.5);
    ...
    doc
      .font(TimesNewRomanNormal)
      .fontSize(12)
      .text("Программа рассмотрена на заседании кафедры:")
      .moveDown(1);
    doc
      .text(
        "___________________________________________________________________________"
    ...
    doc
      .font(TimesNewRomanItalic)
      .fontSize(10)
      .text("(название кафедры)", { align: "center" })
      .moveDown(2.5);

    doc
      .font(TimesNewRomanNormal)
      .fontSize(12)
      .text("Протокол заседания № _____ от «____» _______ 20___ г.")
      .moveDown(0.5);
    doc
      .text("Заведующий кафедрой      __________________________________")
      .moveDown(0.2);
    doc
      .font(TimesNewRomanItalic)
      .fontSize(10)
      .text("(Фамилия И.О., подпись)", { align: "right", width: "300" })
      .moveDown(3.5);

    doc.font(TimesNewRomanNormal).fontSize(12).text("СОГЛАСОВАНО").moveDown(1);
    doc
      .text("Заведующий выпускающей кафедрой  _______________________")
      .moveDown(0.2);
    doc
      .font(TimesNewRomanItalic)
      .fontSize(10)
      .text("(Фамилия И.О., подпись)", { align: "right", width: "340" })
      .moveDown(3.5);
    doc
      .font(TimesNewRomanNormal)
      .fontSize(12)
      .text("«____» _______ 20___ г.")
      .moveDown(1);
    ...
    doc
      ...
      .fontSize(12)
      .text("1. Цели и задачи освоения дисциплины")
      .moveDown(1);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("2. Место дисциплины в структуре ОПОП")
      .moveDown(1);
    doc
      .font(TimesNewRomanNormal)
      .text(
        `Дисциплина «${jsonData.disciplins_name}» относится к ${jsonData.place} учебного плана направления «${jsonData.direction_of_study}». Дисциплина преподается в ${jsonData.semester} семестре, на 1 курсе, форма промежуточной аттестации – ${jsonData.certification}`,
        { align: "justify", indent: 20 }
      )
      .moveDown(1);
    doc
      .text(jsonData.place_more_text, { align: "justify", indent: 20 })
      .moveDown(1);

    doc
      .font(TimesNewRomanBold)
      .text("3. Планируемые результаты обучения по дисциплине (модулю)")
      .moveDown(2);
    doc.font(TimesNewRomanNormal);
    ...
    doc
      .font(TimesNewRomanNormal)
      .text(
        `Объем дисциплины составляет ${jsonData.zet} зачетных единиц, всего 144 академических часов. `,
        { align: "justify" }
      )
      .moveDown(1);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("Содержание дисциплины", { align: "center" })
      .moveDown(0.5);
    doc.font(TimesNewRomanNormal);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("6. Перечень учебно-методического обеспечения по дисциплине")
      .moveDown(0.5);
    doc.font(TimesNewRomanNormal);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("7. Фонды оценочных средств по дисциплине")
      .moveDown(0.5);
    doc.font(TimesNewRomanNormal);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("Профессиональные базы данных и информационные справочные системы")
      .moveDown(0.5);
    doc.font(TimesNewRomanNormal);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("Необходимое программное обеспечение")
      .moveDown(0.5);
    doc.font(TimesNewRomanNormal);
    ...
    doc
      .font(TimesNewRomanBold)
      .text("Необходимое материально-техническое обеспечение")
      .moveDown(0.5);
    doc.font(TimesNewRomanNormal);
